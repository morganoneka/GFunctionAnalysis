...
files <- list.files(path=input, pattern="*_THEORETICAL.csv", full.names=FALSE, recursive=FALSE)
...
write.table(auc_data,fullfile(output, "GcrossAUC_THEORETICAL.csv"),  sep=",", col.names=TRUE, row.names=FALSE)
